pipeline{
   ...
   /*{
    ...
    environment {
        ...
        RELEASE = "1.0.0"
        DOCKER_USER = "satishkamavaram"
        DOCKER_PASS = 'dockerhub' // configure dockerhub as credentials with username and password(token from dockerhub)
    ...
    stages{
        ...
        stage("Checkout from SCM"){
            steps {
                git branch: 'main', credentialsId: 'github', url: 'https://github.com/satishkamavaram/complete-prodcution-e2e-pipeline'
            }
    ...
    post {
        failure {
            emailext body: '''${SCRIPT, template="groovy-html.template"}''', 
                    ...
                    mimeType: 'text/html',to: "satishkamavaram@gmail.com"
            }
         success {
               emailext body: '''${SCRIPT, template="groovy-html.template"}''', 
